...
@section('title', 'send_to_my_emails')
@section ('content')
    <div class="content" >
    <div  id="alert">
        ...
        <div class="d-flex align-items-center mb-4">
          <h2 class="m-0">#Send To My Emails</h2>
        </div>
        ...
        <div class="flex-grow-1"></div>
              <div class="m-2">
                <button class="btn btn-primary px-5 add" onClick="event.preventDefault();" data-toggle="modal" data-target="#addEdit-new-modal"> ADD New Send To My Email <i class="ml-2 fas fa-plus-circle"></i></button>
              </div>
          </div>
        <div class="table-responsive">
          <table class="table bg-light mb-4 tableInfo" id="tableInfo" dir="rtl">
            @include('dashboard.send_to_my_emails.tableInfo')
          </table>
        </div>
      ...
      <!-- Large modal -->
      @include('dashboard.send_to_my_emails.viewModal')
      <!-- end Large modal -->

      <!-- addEdit new modal -->
        @include('dashboard.send_to_my_emails.addEditModal')
      <!-- end add user modal -->
