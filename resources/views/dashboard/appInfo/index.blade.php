    ...
    <div  id="alert">
      ...
      <div class="form-row">
        <div class="flex-grow-1"></div>
              <div class="m-2">
                <button class="btn btn-primary px-5 settings" onClick="event.preventDefault();" data-toggle="modal" data-target="#addEdit-new-modal"><span class="list-lang" Ar="تعديل" En="edit"> </span> <i class="ml-2 fas fa-plus-circle"></i></button>
              </div>
          </div>
