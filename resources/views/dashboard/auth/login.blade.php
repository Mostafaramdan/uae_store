                    ...
                    <form method="POST" action="{{ route('dashboard.login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @endif
                                @if(Session::has('incorrectEmail'))
                                    <span style="color:red;">{{Session::get('incorrectEmail')}} </span>
                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @if(Session::has('incorrectPassword')) is-invalid @endif" name="password" required autocomplete="current-password">
