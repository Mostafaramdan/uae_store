...
@section ('content')
    ...
    <div  id="alert">
          ...
          <div class="form-row">
            ...
            <div class="m-2">
              <select class="custom-select" name="sortBy">
                ...
                <option value="statusAr" class="list-lang" ar="الحالة" en="status"></option>
            ...
            <div class="m-2">
              <div class="form-group " >
                  <label for="users_id" class="col-form-label list-lang" ar="أدخل المستخدم" en="insert a user">  :</label>
            ...
            <div class="m-2">
              <div class="form-group " >
                  <label for="drivers_id" class="col-form-label list-lang" ar="أدخل سائق" en="insert a driver">   :</label>
            ...
            <div class="m-2">
              <div class="form-group " >
                  <label for="stores_id" class="col-form-label list-lang" ar="أدخل متجر" en="insert a store">  :</label>
              ...
              <div class="col-md-12">
                <div class="m-2">
                    <button class="btn btn-warning px-5 print list-lang" onClick="event.preventDefault();print();" data-toggle="modal" data-target="#addEdit-new-modal" ar="طباعة <i class='ml-2 fas fa-print'></i>  " en="print <i class='ml-2 fas fa-print'></i>">  </button>
                </div>
              </div>
            </div>
        </form>
        <div class="row mb-4">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="card text-white bg-dark  mb-3" style="max-width: 18rem;height:90%">
              <div class="card-header align-items-center font-weight-bold">
                 أجمالي العمولة  
        ...
        <div class="table-responsive">
          <table class="table bg-light mb-4 tableInfo" id="tableInfo" dir="rtl">
            @include('dashboard.reports.tableInfo')
          </table>
        </div>
      ...
      <!-- Large modal -->
      @include('dashboard.reports.viewModal')
      <!-- end Large modal -->

      <!-- addEdit new modal -->
      <!-- end add user modal -->
        @include('dashboard.reports.orderInfoModal')
