...
@section('title', 'stores_has_regions')
@section ('content')
    <div class="content" >
    <div  id="alert">
    </div>
        <div class="d-flex align-items-center mb-4">
          <h2 class="m-0">#Stores Has Regions</h2>
        </div>
          ...
          <div class="form-row">
            ...
            <div class="m-2">
              <select class="custom-select"  name="sortType">
                ...
                <option value="sortBy">Aescending</option>
        ...
        <div class="flex-grow-1"></div>
              <div class="m-2">
                <button class="btn btn-primary px-5 add" onClick="event.preventDefault();" data-toggle="modal" data-target="#addEdit-new-modal"> ADD New Stores Has Region <i class="ml-2 fas fa-plus-circle"></i></button>
              </div>
          </div>
        <div class="table-responsive">
          <table class="table bg-light mb-4 tableInfo" id="tableInfo" dir="rtl">
            @include('dashboard.stores_has_regions.tableInfo')
          </table>
        </div>
      ...
      <!-- Large modal -->
      @include('dashboard.stores_has_regions.viewModal')
      <!-- end Large modal -->

      <!-- addEdit new modal -->
        @include('dashboard.stores_has_regions.addEditModal')
      <!-- end add user modal -->
