<div class="modal fade" id="addEdit-new-modal" tabindex="-1" role="dialog" aria-labelledby="addEdit-new-modal"aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <form  id="createUpdate" action="{{route('dashboard.'.Request::segment(2).'.createUpdate')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <button class="btn btn-primary btn-block" onClick="event.preventDefault();$('#img').click();">اختر صورة</button>
                            <input type="file" id="img" name="img" accept="image/*" hidden >
                            <img id="openImage"  alt="your image"  class="img-thumbnail"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
            ...
            <div class="modal-footer">
                ...
                <button type="button"  class="btn btn-success" id="submit">Send message</button>
            </div>
