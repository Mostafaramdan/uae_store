...
@section ('content')
    ...
    <div  id="alert">
        ...
        <div class="flex-grow-1"></div>
              <div class="m-2">
                <button class="btn btn-primary px-5" onClick="event.preventDefault();" data-toggle="modal" data-target="#addEdit-new-modal">ADD New <i
                    class="ml-2 fas fa-plus-circle"></i></button>
              </div>
          </div>

        <table class="table bg-light mb-4 tableInfo" id="tableInfo" dir="rtl">
          @include('dashboard.roles.tableInfo')
        </table>
      ...
      <!-- Large modal -->
      @include('dashboard.roles.viewModal')
      <!-- end Large modal -->

      <!-- addEdit new modal -->
        @include('dashboard.roles.addEditModal')
      <!-- end add user modal -->
