            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group" >
                        ...
                        <select  class="form-control" name="owners_id">
                        </select>
                    </div>
                    <div class="row mr-10" >
                        ...
                        <div class="col-md-12">
                          <input type="file" id="img" name="room_image" accept="image/*" hidden data-image="room_image" >
                    ...
                    <div class="row mr-10" >
                        ...
                        <div class="col-md-12">
                          <input type="file" id="img" name="background_image" accept="image/*" hidden data-image="background_image" >
