    ...
    <div  id="alert">
          ...
          <div class="form-row">
            ...
            <div class="m-2">
              <select class="custom-select" name="sortBy">
                <option selected disabled>ترتيب بواسطة</option>
                <option value="questionAr">السؤال بالعربي</option>
                <option value="answerAr">الجواب بالعربي</option>
              </select>
            </div>
            <div class="m-2">
              <select class="custom-select"  name="sortType">
                <option selected disabled>نوع الترتيب</option>
                <option value="sortBy">ترتيب تصاعدي</option>
                <option value="sortByDesc">ترتيب تنازلي</option>
              </select>
            </div>
        </form>
        ...
        <div class="table-responsive">
          <table class="table bg-light mb-4 tableInfo" id="tableInfo" dir="rtl">
            @include('dashboard.faqs.tableInfo')
          </table>
        </div>
      ...
      <!-- Large modal -->
      @include('dashboard.faqs.viewModal')
      <!-- end Large modal -->

      <!-- addEdit new modal -->
        @include('dashboard.faqs.addEditModal')
      <!-- end add user modal -->
