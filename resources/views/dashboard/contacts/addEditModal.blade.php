        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="email" class="col-form-label list-lang" ar="البريد الالكتروني" en="email">البريد الالكتروني :</label>
                        <input type="text" class="form-control" name="email">
                    </div>
                    <div class="form-group">
                        <label for="phone" class="col-form-label  list-lang" ar="  رقم التليفون" en="phones" >رقم التليفون:</label>
                    ...
                    <div class="form-group" >
                        <label for="regionId" class="col-form-label list-lang" ar=" اختر المدينة " en="choose a city">اختر المدينة:</label>
                        <select  class="form-control" name="regionId">
                            @foreach(\App\Models\regions::where('regions_id','!=',null)->get() as $region)
                                <option  class=" list-lang"value="{{$region->id}}">{{$region->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
