...
use App\Models\recharges as model;
...
public static function index()
{
    ...
    return view('dashboard.recharges.index',compact("records","totalPages",'currentPage'));
}   
...
public static function indexPageing(Request $request)
{
  ...
  $records= self::$model::all()->$sort($request->sortBy??"id",);    if($request->search){
    ...
    $tableInfo= (string) view('dashboard.recharges.tableInfo',compact('records'));
