...
class reports extends Controller
{
      ...
      public static function index() 
      {
            ...
            return view('dashboard.reports.index',compact('totalDistance',"records","totalPages",'currentPage','totalPrice','productPrice','deliveryPrice','storeFees','driverFees'));
      }   
      ...
      public static function print(Request $request)
      {
            ...
            return view('dashboard.reports.indexPrint',compact("records",'totalPrice','productPrice','deliveryPrice','storeFees','driverFees'));
      }
