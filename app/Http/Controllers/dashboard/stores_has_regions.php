...
use App\Models\stores_has_regions as model;

class stores_has_regions extends Controller
{
public static $model;
...
public static function index()
{
    ...
    return view('dashboard.stores_has_regions.index',compact("records","totalPages",'currentPage'));
}   
...
public static function indexPageing(Request $request)
{
  ...
  $records= self::$model::all()->$sort($request->sortBy??"id",);    if($request->search){
    ...
    $tableInfo= (string) view('dashboard.stores_has_regions.tableInfo',compact('records'));
