...
use App\Models\bank_accounts as model;

class bank_accounts extends Controller
{
public static $model;
...
public static function index()
{
    ...
    return view('dashboard.bank_accounts.index',compact("records","totalPages",'currentPage'));
}   
...
public static function indexPageing(Request $request)
{
  ...
  $records= self::$model::all()->$sort($request->sortBy??"id",);    if($request->search){
    ...
    $tableInfo= (string) view('dashboard.bank_accounts.tableInfo',compact('records'));
