...
use App\Http\Controllers\Apis\Helper\helperController as helper;
...
public static function index()
{
    ...
    return view('dashboard.logs.index',compact("records","totalPages",'currentPage'));
}   
...
public static function indexPageing(Request $request)
{
    ...
    $tableInfo= (string) view('dashboard.logs.tableInfo',compact('records'));
...
public static function createUpdate(Request $request){
    ...
    return response()->json(['status'=>200,'message'=>$message,'record=']);
}
