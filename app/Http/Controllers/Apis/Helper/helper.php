...
class helper extends generalHelp
{
	...
	public static function sendSMS($phone, $msg)
	{
		...
		$url='https://api.smscountry.com/SMSCwebservice_bulk.aspx?User=uaestore112&passwd=Salem1989&mobilenumber='.$phone.'&message='.$msg.'&sid=UAE STORE&mtype=N&DR=Y';
