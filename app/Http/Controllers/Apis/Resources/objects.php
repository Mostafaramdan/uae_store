...
class objects extends index
{
    ...
    public static function location ($record)
    {
        ...
        $object = [];
        $object['id']=$record->id;
        $object['longitude']=(double)$record->longitude;
        $object['latitude']=(double)$record->latitude;
    ...
    public static function product  ($record)
    {
        ...
        $object['store'] = self::store($record->category->store);
        $object['quantity'] = $record->quantity;
        ...
        if(self::$account)
            ...
            $object['isFav'] = false;
        $object['isFreeDelivered'] =  $record->isFreeDelivered?true:false;   
        $object['hasOffer'] = $record->hasOffer;
    ...
    public static function offer ($record)
    {
        ...
        $object['id'] = $record->id;
        $object['product'] = self::product($record->product);
        $object['discount'] = (double)$record->discount;
    ...
    public static function appInfo ($record)
    {
        ...
        $object['pricePer20Km'] = (double)$record->pricePer20Km;
        return $object;
    }
